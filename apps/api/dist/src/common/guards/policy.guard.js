...
const policy_resource_decorator_1 = require("../decorators/policy-resource.decorator");
let PolicyGuard = class PolicyGuard {
    constructor(reflector) {
        this.reflector = reflector;
    }
    canActivate(context) {
        const resource = this.reflector.get(policy_resource_decorator_1.POLICY_RESOURCE_KEY, context.getHandler());
