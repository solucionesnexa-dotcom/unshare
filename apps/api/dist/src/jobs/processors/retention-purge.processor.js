...
let RetentionPurgeProcessor = class RetentionPurgeProcessor extends bullmq_1.WorkerHost {
    async process(job) { return { ok: true, id: job.id }; }
};
exports.RetentionPurgeProcessor = RetentionPurgeProcessor;
exports.RetentionPurgeProcessor = RetentionPurgeProcessor = __decorate([
